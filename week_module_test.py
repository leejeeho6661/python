...
class adminClass:
    ...
    def itemAll(self):
        ...
        if len(rows) == 0:
            ...
            for row in rows:
                print("{:<3}{:<20}{:<20,}{:<4}{}".format(row['id'],row['product_name'],row['product_price'],row['product_qty'],row['created_at']))
    ...
    def monthlyMember(self):
        ...
        if len(rows)==0:
            ...
            for row in rows:
                print('{:<30}{:<30,}{}'.format(row['Purchase'],row['Total Price'],row['member_id']))
        self.adminPage()
...
class normalClass:
    ...
    def searchItem(self):
        ...
        if len(rows)==0:
            ...
            for row in rows:
                print('{:<30}{:<20,}{:<5,}'.format(row['product_name'],row['product_price'],row['product_qty']))
        self.userPage()
    ...
    def itemList(self):
        ...
        if len(rows) == 0:
            ...
            for row in rows:
                print('{:<30}{:<10,}{:<5,}'.format(row['product_name'],row['product_price'],row['product_qty']))
    ...
    def myOrderList(self):
        ...
        try:
            ...
            if len(rows) == 0:
                ...
                for row in rows:
                    print('{:<30}{:<20,}{:<10,}{}'.format(row['item_name'],row['order_price'],row['order_qty'],row['created_at']))
